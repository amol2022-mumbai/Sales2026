...
router.get('/export', requireExport, authorize('customers:export'), validate(exportCustomersQuerySchema, 'query'), consumeFeature('exports'), exportCustomers);
...
router.post('/', authorize('customers:create'), validate(createCustomerSchema), requireFeatureLimit('customers'), createCustomer);
