...
import { companySettingsSchema, idParamSchema, paginationQuerySchema } from '../schemas/index.js';
import { listCompanies, getCompany, updateCompany } from '../controllers/companyController.js';
